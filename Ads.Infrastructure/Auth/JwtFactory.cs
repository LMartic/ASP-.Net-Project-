...
namespace Ads.Infrastructure.Auth
{
    public class JwtFactory : IJwtFactory
    {
        ...
        public JwtFactory(IOptions<JwtIssuerOptions> jwtOptions, UserManager<ApplicationUser> userManager, IConfiguration configuration)
        {
